...
class BloggerSocial(models.Model):
    name = models.CharField(default="", max_length=20, verbose_name="名称", help_text="名称")
    blogger = models.ForeignKey(BloggerInfo, verbose_name="个人", help_text="个人",on_delete=models.CASCADE)
    social = models.ForeignKey(MaterialSocial, verbose_name="社交平台", help_text="社交平台",on_delete=models.CASCADE)
...
class BloggerMaster(models.Model):
    name = models.CharField(default="", max_length=20, verbose_name="名称", help_text="名称")
    blogger = models.ForeignKey(BloggerInfo, verbose_name="个人", help_text="个人",on_delete=models.CASCADE)
    master = models.ForeignKey(MaterialMaster, verbose_name="技能", help_text="技能",on_delete=models.CASCADE)
    index = models.IntegerField(default=0, verbose_name="顺序", help_text="顺序")
    add_time = models.DateTimeField(auto_now_add=True, null=True, blank=True, verbose_name="添加时间", help_text="添加时间")
...
class SiteInfoNavigation(models.Model):
    name = models.CharField(default="", max_length=20, verbose_name="名称", help_text="名称")
    site = models.ForeignKey(SiteInfo, verbose_name="网站", help_text="网站",on_delete=models.CASCADE)
    navigation = models.ForeignKey(NavigationLink, verbose_name="导航", help_text="导航",on_delete=models.CASCADE)
    index = models.IntegerField(default=0, verbose_name="顺序", help_text="顺序")
    add_time = models.DateTimeField(auto_now_add=True, null=True, blank=True, verbose_name="添加时间", help_text="添加时间")
